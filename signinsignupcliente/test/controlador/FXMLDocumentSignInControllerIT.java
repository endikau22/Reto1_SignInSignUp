...
public class FXMLDocumentSignInControllerIT extends ApplicationTest{
    ...
    */ 
    ...
    /**
     * Test para comprobar que cuando los datos son correctos y el usuario está en la BBDD se accede a la escena LogOut.
     */
    @Test
    ...
    /**
     * Test para comprobar que el un usuario existente introduce una contraseña incorrecta
     */
    @Test
    public void testL_IntroducirUsuarioCorrectoPasswordIncorrecto(){
        clickOn("#txtFieldUsuario");
        write("usuario");
        clickOn("#pswFieldContrasena");
        write("passwordd");
        clickOn("#btnEntrar");
        verifyThat("#lblErrorUsuarioContrasena",LabeledMatchers.hasText("Password incorrecto."));
    }
    /**
     * Test para comprobar que el un usuario existente introduce una contraseña incorrecta
     */
    @Test
    public void testM_IntroducirUsuarioInCorrecto(){
        clickOn("#txtFieldUsuario");
        write("usuario23");
        clickOn("#pswFieldContrasena");
        write("password");
        clickOn("#btnEntrar");
        verifyThat("#lblErrorUsuarioContrasena",LabeledMatchers.hasText("El usuario no existe."));
    }
}
